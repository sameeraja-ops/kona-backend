...
class AdminRouter {
  ...
  private initializeRoutes(): void {
    ...
    this.router.get('/getBatchDetailById/:batchId', verifyToken,this.adminController.getBatchDetailById);
    ...
    this.router.get('/allCourseBatches', verifyToken,this.adminController.allCourseBatches);
    ...
    this.router.get('/allUsers', verifyToken,this.adminController.allUsers);
