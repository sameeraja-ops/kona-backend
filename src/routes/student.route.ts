...
class StudentRouter {
  ...
  private initializeRoutes(): void { 
    ...
    this.router.post('/deleteProfilePic',verifyToken, this.studentController.deleteProfilePic);
    ...
    this.router.get('/getBatchesProgressByStudentId',verifyToken, this.studentController.getBatchesProgressByStudentId);
